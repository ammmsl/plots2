...
| Section | Change |
|---|---|
| Header | Version number added; companion document list expanded to reference all six sibling documents. |
| §6.3 Tension-to-relief approximation model | **Deprecation notice added.** The compliance coefficient model described in this section was superseded by the flat-neck datum approach introduced in `guitar_setup_parameters_v3.md`. The section is preserved for reference but should not be used as the active relief prediction method. |
| §10 Document Relationships | Section rewritten to reflect the full six-document system: `setup_guide_architecture.md`, `feature_layers.md`, `setup_optimisation_engine.md`, and `agent_access_spec.md` all consume data from this document and are now cross-referenced. |
...
> ⚠️ **Deprecated in v1.1.** The compliance coefficient model described below was the original approach for predicting neck relief from total string tension. It has been superseded by the **flat-neck datum** approach introduced in [`guitar_setup_parameters_v3.md §2.7`](./guitar_setup_parameters_v3.md#27-neck-setup). Under the datum approach, the neck is brought to confirmed flat under full string tension — the datum itself — and relief is then measured from that zero point rather than predicted from a compliance coefficient. This eliminates the estimation error inherent in a fixed-coefficient model. Do not use the compliance model as the active relief prediction path in any new implementation. This section is preserved for historical reference and to explain the evolution of the model.
>
> Cross-reference: the supersession of this model is noted in [`guitar_setup_parameters_v3.md §7`](./guitar_setup_parameters_v3.md#7-document-relationships) and the required update was tracked in [`setup_guide_architecture.md §9`](./setup_guide_architecture.md#9-content-additions-required-in-companion-documents).

The neck does not respond linearly to total tension — its stiffness varies by construction. A working approximation *(historical — see deprecation note above)*:
...
> **Original MVP simplification (archived):** Model this as a linear coefficient with three presets (bolt-on / set / through) rather than trying to compute true neck stiffness from wood properties.
...
This document is the **physics foundation** for the full six-document system. Every document that computes or displays string tension draws its formula, unit weights, and tuning presets from here.

```mermaid
graph TD
    TDB["string_tension_database.md\n(this document)\n— Physics formula\n— Unit weight schema\n— Tuning preset library\n— Scraping strategy"]

    PARAMS["guitar_setup_parameters_v3.md\n§2.4 String Set\n§2.5 Tuning\n§2.11 Tension Profile"]
    GUIDE["setup_guide_architecture.md\n§3 Layer map\n§7 TensionDashboard component"]
    TOOLS["setup_tools_reference.md\nTool-to-parameter mapping"]
    LAYERS["feature_layers.md\nLayer 3 — Tension simulation\nLayer 4 — Optimisation engine"]
    OPT["setup_optimisation_engine.md\n§2.2 Physics formula\n§2.2 Gauge suitability\n§2.2 Balance score"]
    AGENT["agent_access_spec.md\n§4.2 Tension calculations\n§4.3 String sets\n§4.4 Tuning presets\nPOST /tension endpoint"]

    TDB -->|"tension formula, unit weights, tuning presets"| PARAMS
    TDB -->|"tuning data, tension physics"| GUIDE
    TDB -->|"string set context for tool workflows"| TOOLS
    TDB -->|"tension engine for Layer 3 + 4"| LAYERS
    TDB -->|"formula + gauge suitability + balance score"| OPT
    TDB -->|"unit weights, tuning presets, on-demand tension calc"| AGENT

    PARAMS -->|"§10 integration points — all setup params"| TDB
    PARAMS -->|"§8 user flow — UI sequence"| TDB
```

| From this document | Consumed by |
|---|---|
| Tension formula `T = UW × (2 × L × f)²` | [`guitar_setup_parameters_v3.md §2.4`](./guitar_setup_parameters_v3.md#24-string-set), [`setup_optimisation_engine.md §2.2`](./setup_optimisation_engine.md#22-from-string_tension_databasemd), [`agent_access_spec.md §4.2`](./agent_access_spec.md#42-tension-calculations) |
| `unit_weight` per string | [`guitar_setup_parameters_v3.md §2.4`](./guitar_setup_parameters_v3.md#24-string-set), [`agent_access_spec.md §4.3`](./agent_access_spec.md#43-string-sets) |
| Tuning preset library (§4) | [`guitar_setup_parameters_v3.md §2.5`](./guitar_setup_parameters_v3.md#25-tuning), [`agent_access_spec.md §4.4`](./agent_access_spec.md#44-tuning-presets), [`setup_optimisation_engine.md §2.2`](./setup_optimisation_engine.md#22-from-string_tension_databasemd) |
| Gauge suitability thresholds (§6.4) | [`guitar_setup_parameters_v3.md §2.11`](./guitar_setup_parameters_v3.md#211-tension-profile-updated-in-v30), [`setup_optimisation_engine.md §2.2`](./setup_optimisation_engine.md#22-from-string_tension_databasemd) |
| Tension balance score (§6.5) | [`guitar_setup_parameters_v3.md §2.11`](./guitar_setup_parameters_v3.md#211-tension-profile-updated-in-v30), [`setup_optimisation_engine.md §2.2`](./setup_optimisation_engine.md#22-from-string_tension_databasemd) |
| Scraping strategy (§5) | Implementation reference — no downstream doc dependency |
| ~~§6.3 Compliance model~~ | **Deprecated.** Superseded by flat-neck datum in [`guitar_setup_parameters_v3.md §2.7`](./guitar_setup_parameters_v3.md#27-neck-setup). |

---

*Document version 1.1*
*v1.1 changes: §6.3 compliance model deprecated with supersession notice; §10 Document Relationships expanded to cover all six sibling documents.*
*Companion documents: [`guitar_setup_parameters_v3.md`](./guitar_setup_parameters_v3.md) · [`setup_guide_architecture.md`](./setup_guide_architecture.md) · [`setup_tools_reference.md`](./setup_tools_reference.md) · [`feature_layers.md`](./feature_layers.md) · [`setup_optimisation_engine.md`](./setup_optimisation_engine.md) · [`agent_access_spec.md`](./agent_access_spec.md)*
