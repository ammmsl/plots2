...
**Version:** 1.0
**Companion documents:** `guitar_setup_parameters_v3.md` · `string_tension_database.md` · `setup_guide_architecture.md`
...
agent_access_spec.md (this document)
  ↓ exposes data from
guitar_setup_parameters_v3.md   — problem index, parameter definitions
string_tension_database.md      — unit weights, tension formula, tuning presets
setup_tools_reference.md        — tool catalogue, cost ranges
setup_guide_architecture.md     — ProblemRecord schema, SkillTier definitions
...
The companion documents are not modified by this spec. This document defines a read interface over them. The underlying knowledge is unchanged; this layer makes it machine-queryable.

---

*Document version 1.0*
*Companion documents: `guitar_setup_parameters_v3.md` · `string_tension_database.md` · `setup_guide_architecture.md` · `setup_tools_reference.md`*
